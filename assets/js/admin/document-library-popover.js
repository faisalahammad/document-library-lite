...
(() => {
/*!***************************************************************!*\
  !*** ./assets/js/src/admin/document-library-popover/index.js ***!
  \***************************************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener('DOMContentLoaded', () => {
  const popoverButtons = document.querySelectorAll('span.dlw-help-tip[popovertarget]');
  ...
  const createArrowElement = () => {
    ...
    fillPath.setAttribute('d', `M0,0 H${width} L${width / 2},${height} Z`);
    ...
    rightDiagonalStroke.setAttribute('d', `M${width},0 L${width / 2},${height}`);
    rightDiagonalStroke.setAttribute('stroke', grayStrokeColor);
    rightDiagonalStroke.setAttribute('stroke-width', String(strokeWidth));
    ...
    leftDiagonalStroke.setAttribute('d', `M${width / 2},${height} L0,0`);
    leftDiagonalStroke.setAttribute('stroke', grayStrokeColor);
    leftDiagonalStroke.setAttribute('stroke-width', String(strokeWidth));
  ...
  popoverButtons.forEach(helpTip => {
    ...
    const showDelay = 500;
    const hideDelay = 300;
    const popoverEl = document.querySelector('#' + helpTip.getAttribute('popovertarget'));
    ...
    const showPopover = popover => {
      ...
      showTimeout = setTimeout(() => {
        ...
        const updatePosition = () => {
          ...
          (0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.computePosition)(helpTip, popover, {
            placement: preferredPlacement,
            middleware: [(0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.offset)(offsetDistance), (0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.flip)(), (0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.shift)({
              padding: 14
            ...
            const leftOffset = placement.startsWith('left') ? -15 : 0;
        ...
        cleanup = (0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.autoUpdate)(helpTip, popover, updatePosition);
      }, showDelay);
    };
...
/******/ })()
;
//# sourceMappingURL=document-library-popover.js.map